...
class WebAppConfig(
    ...
    val APP_URL: String,
    val APP_URL_PARAMS: String,
    val DIMEN_PARAM_NAME: String,
    val TYPE_PARAM_NAME: String,
    val RESOLUTION_WDTH_PARAM_NAME: String,
    val RESOLUTION_HGHT_PARAM_NAME: String,
...
class Css(
    ...
    val PUZZLE_CELL_CHAR_DECR_HGHT_PERC: Float,
    ...
    val PUZZLE_CELL_FOCUSED: String,
    //val PUZZLE_CELL_FOCUSED_ANIM_DURTN: Float,
